...
let UserPostService = class UserPostService {
    ...
    findAll() {
        return rxjs_1.from(this.postRepository.find({ relations: ['author'],
            order: { id: "DESC" } }));
    }
    findOne(id) {
    ...
    updateOne(id, blogEntry) {
        return rxjs_1.from(this.postRepository.update(id, blogEntry)).pipe(operators_1.switchMap(() => this.findOne(id)));
    }
    deleteOne(id) {
